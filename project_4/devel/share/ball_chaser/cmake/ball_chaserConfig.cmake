...
if("TRUE" STREQUAL "TRUE")
  set(ball_chaser_SOURCE_PREFIX /home/workspace/project_4/src/ball_chaser)
  set(ball_chaser_DEVEL_PREFIX /home/workspace/project_4/devel)
  ...
  set(ball_chaser_INSTALL_PREFIX /home/workspace/project_4/install)
...
if(NOT "/home/workspace/project_4/devel/include " STREQUAL " ")
  set(ball_chaser_INCLUDE_DIRS "")
  set(_include_dirs "/home/workspace/project_4/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ball_chaser' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/workspace/project_4/src/ball_chaser/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/workspace/project_4/devel/lib;/opt/ros/kinetic/lib)
